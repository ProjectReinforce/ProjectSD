...
namespace SwDreams.Features.Boss.Presentation
{
    /// <summary>
    /// 보스 체력 바. 화면 상단 고정.
    /// 페이즈 구분선(60%, 30%) 표시.
    ...
    public class BossHealthBarUI : MonoBehaviour
    {
        ...
        private SwDreams.Features.Boss.Adapter.Boss currentBoss;
        ...
        private void Update()
        {
            ...
            if (!isTracking)
            {
                ...
                {
                    var boss = FindAnyObjectByType<SwDreams.Features.Boss.Adapter.Boss>();
        ...
        private void AttachToBoss(SwDreams.Features.Boss.Adapter.Boss boss)
        {
            currentBoss = boss;
            isTracking = true;
            SetVisible(true);

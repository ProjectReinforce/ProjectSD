...
*실제 값은 `Assets/Data/Skills/sanctuary_01.asset`.*

| 레벨 | 틱 회복량 | 쿨다운 | 반경 | 지속시간 | 틱 간격 |
|---|---|---|---|---|---|
| 1 | — | — | — | — | *TBD* |
...
- **SO 타입:** `AreaSkillData` (Single)
- **에셋 경로:** `Assets/Data/Skills/sanctuary_01.asset`
- **주요 필드:** firingMode=Single, applicableStats=[스킬 범위, 체력 회복량 증가, 스킬 유지 시간], progression 내 heal/damage 수치
